...
public class VerticalNewsAdapter extends RecyclerView.Adapter<VerticalNewsAdapter.ViewHolder> {
    ...
    public VerticalNewsAdapter(List<NewsItem> items, OnItemClickListener listener) {
        this.items = items;
